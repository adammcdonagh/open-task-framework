...
docker exec -it ssh_1 /bin/sh -c "usermod -G operator -a application"
docker exec -it ssh_2 /bin/sh -c "usermod -G operator -a application"
docker exec -it ssh_1 /bin/sh -c "mkdir -p ~application/.ssh"
docker exec -it ssh_2 /bin/sh -c "mkdir -p ~application/.ssh"
...
docker exec -it ssh_1 /bin/sh -c "chown -R application ~application/.ssh && chmod -R 700 ~application/.ssh"
...
docker exec -it ssh_2 /bin/sh -c "chown -R application ~application/.ssh && chmod -R 700 ~application/.ssh"
